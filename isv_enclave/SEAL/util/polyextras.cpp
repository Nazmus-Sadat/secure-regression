...
namespace seal
{
    namespace util
    {
        ...
        void exponentiate_poly(const uint64_t *poly, int poly_coeff_count, int poly_coeff_uint64_count, int exponent,
        ...
        void exponentiate_poly(const uint64_t *poly, int exponent, const PolyModulus &poly_modulus, const Modulus &modulus, uint64_t *result, MemoryPool &pool)
        {
#ifdef _DEBUG
            if (poly == nullptr)
            {
