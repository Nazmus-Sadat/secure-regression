...
namespace seal
{
    namespace util
    {
        ...
        Modulus::Modulus(const uint64_t *modulus, int uint64_count) : modulus_(modulus), uint64_count_(uint64_count), power_of_two_minus_one_(-1)
        {
#ifdef _DEBUG
            if (modulus == nullptr)
            {
        ...
        Modulus::Modulus(const uint64_t *modulus, int uint64_count, MemoryPool &pool) : modulus_(modulus), uint64_count_(uint64_count), power_of_two_minus_one_(-1)
        {
#ifdef _DEBUG
            if (modulus == nullptr)
            {
