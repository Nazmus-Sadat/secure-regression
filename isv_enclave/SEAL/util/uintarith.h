...
namespace seal
{
    namespace util
    {
        ...
        inline bool add_uint_uint(const uint64_t *operand1, const uint64_t *operand2, int uint64_count, uint64_t *result)
        {
        ...
        inline bool sub_uint_uint(const uint64_t *operand1, const uint64_t *operand2, int uint64_count, uint64_t *result)
        {
        ...
        inline void divide_uint_uint(const uint64_t *numerator, const uint64_t *denominator, int uint64_count, uint64_t *quotient, uint64_t *remainder, MemoryPool &pool)
        {
