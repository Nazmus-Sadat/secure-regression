...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        bool select_parameters(const ChooserPoly &operand, double noise_standard_deviation, EncryptionParameters &destination);
        ...
        @see ChooserEvaluator::default_parameter_options() for the default set of parameter options.
        */
        bool select_parameters(const std::vector<ChooserPoly> &operands, double noise_standard_deviation, EncryptionParameters &destination);
    ...
    */
    ...
    public:
        ...
        */
        ChooserPoly encode(uint64_t value);
        ...
        @see BalancedEncoder::encode() for the corresponding function returning a real polynomial.
        */
        void encode(uint64_t value, ChooserPoly &destination);
        ...
        @see BalancedEncoder::encode() for the corresponding function returning a real polynomial.
        */
        ChooserPoly encode(int64_t value);
        ...
        @see BalancedEncoder::encode() for the corresponding function returning a real polynomial.
        */
        void encode(int64_t value, ChooserPoly &destination);
        ...
        */
        ...
        @see BalancedEncoder::encode() for the corresponding function returning a real polynomial.
        */
        ChooserPoly encode(int32_t value)
        {
        ...
        @see BalancedEncoder::encode() for the corresponding function returning a real polynomial.
        */
        ChooserPoly encode(uint32_t value)
        {
