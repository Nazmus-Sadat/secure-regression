...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        BigUInt(int bit_count, uint64_t *value);
        ...
        */
        ...
        @see BigUInt for a more detailed description of aliased BigUInts.
        */
        void alias(int bit_count, uint64_t *value);
        ...
        */
        ...
        @param[in] operand2 The second operand to add
        */
        BigUInt operator +(uint64_t operand2) const
        {
        ...
        */
        ...
        @param[in] compare The value to compare against
        */
        int compareto(uint64_t compare) const
        {
            BigUInt compareuint;
            compareuint = compare;
        ...
        */
        ...
        @param[in] operand2 The value to compare against
        */
        bool operator <(uint64_t operand2) const
        {
            BigUInt operand2uint;
            operand2uint = operand2;
            return *this < operand2uint;
        ...
        */
        ...
        @throws std::logic_error If the BigUInt is an alias and the operator attempts to enlarge the BigUInt to fit the result
        */
        BigUInt &operator +=(uint64_t operand2)
        {
            BigUInt operand2uint;
            operand2uint = operand2;
            return *this += operand2uint;
        ...
        */
        BigUInt divrem(uint64_t operand2, BigUInt &remainder) const
        {
            BigUInt operand2uint;
            operand2uint = operand2;
        ...
        */
        ...
        @throws std::invalid_argument If the BigUInt value and modulus are not co-prime
        */
        BigUInt modinv(uint64_t modulus) const
        {
            BigUInt modulusuint;
            modulusuint = modulus;
        ...
        */
        ...
        @throws std::logic_error If the inverse is an alias which the function attempts to enlarge to fit the result
        */
        bool trymodinv(uint64_t modulus, BigUInt &inverse) const
        {
            BigUInt modulusuint;
            modulusuint = modulus;
        ...
        */
        static BigUInt of(uint64_t value)
        {
            BigUInt result;
            result = value;
            return result;
