...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        void encode(uint64_t value, BigPoly &destination);
        ...
        */
        uint32_t decode_uint32(const BigPoly &poly);
        ...
        @throws std::invalid_argument if the output does not fit in std::uint32_t
        */
        uint64_t decode_uint64(const BigPoly &poly);
        ...
        */
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        void encode(int64_t value, BigPoly &destination);
        ...
        */
        int32_t decode_int32(const BigPoly &poly);
        ...
        */
        int64_t decode_int64(const BigPoly &poly);
        ...
        */
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        void encode(int32_t value, BigPoly &destination)
        {
            encode(static_cast<int64_t>(value), destination);
        }
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        void encode(uint32_t value, BigPoly &destination)
        {
