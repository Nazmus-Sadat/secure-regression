...
namespace seal
{
    ...
    */
    ...
    private:
        ...
        void preencrypt(const uint64_t *plain, int plain_coeff_count, int plain_coeff_uint64_count, uint64_t *destination);

        void multiply(const uint64_t *encrypted1, const uint64_t *encrypted2, uint64_t *destination);
